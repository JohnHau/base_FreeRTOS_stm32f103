...
//#define EEPROM_I2C_SCL_PIN		GPIO_Pin_5			/* 连接到SCL时钟线的GPIO */
...
#define EEPROM_I2C_SCL_PIN		GPIO_Pin_13			/* 连接到SCL时钟线的GPIO */
#define EEPROM_I2C_SDA_PIN		GPIO_Pin_15			/* 连接到SDA数据线的GPIO */
