...
extern void Time_Regulate_Get(struct rtc_time *tm);
extern void Time_Adjust(struct rtc_time *tm);
extern void Time_Display(uint32_t TimeVar,struct rtc_time *tm);
extern void Time_Show(struct rtc_time *tm);
static uint8_t USART_Scanf(uint32_t value);
extern void RTC_CheckAndConfig(struct rtc_time *tm);


extern uint32_t init_RTC(void);
