...
void Time_Display(uint32_t TimeVar,struct rtc_time *tm)
{
	  ...
	  /* 输出时间戳，公历时间 */
	  printf(" UNIX= %d  %d year %d month %d day  %0.2d:%0.2d:%0.2d\r",
		                  TimeVar,
	                    tm->tm_year, 
	  ...
	  /* 输出时间戳，公历时间 */
	  printf(" UNIX timestamp= %d current date %d year (%s year %d month %d day week %s)  %0.2d:%0.2d:%0.2d\r",TimeVar,
