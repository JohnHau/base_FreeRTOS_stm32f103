...
static void btn_b1_event_cb(lv_event_t * e)
{
    ...
    if(code == LV_EVENT_PRESSED)
    {
        ...
        lv_obj_t *label = lv_obj_get_child(btn,0);
        lv_label_set_text_fmt(label,"btn_b1 cnt is %d",cnt);
...
static void btn_b2_event_cb(lv_event_t * e)
{
    ...
    if(code == LV_EVENT_PRESSED)
    {
        ...
        lv_obj_t *label = lv_obj_get_child(btn,0);
        lv_label_set_text_fmt(label,"btn_b2 cnt is %d",cnt);
...
void lv_create_usr_button(void)
{

    lv_obj_t * btn_b1 = lv_btn_create(lv_scr_act());
    lv_obj_set_pos(btn_b1,20,20);
    lv_obj_set_size(btn_b1,120,50);

    lv_obj_add_event_cb(btn_b1,btn_b1_event_cb,LV_EVENT_ALL,NULL);

    lv_obj_t *label_btn_b1 = lv_label_create(btn_b1);
    lv_label_set_text(label_btn_b1,"button_b1");
    lv_obj_center(label_btn_b1);





    lv_obj_t * btn_b2 = lv_btn_create(lv_scr_act());
    lv_obj_set_pos(btn_b2,20,80);
    lv_obj_set_size(btn_b2,120,50);

    lv_obj_add_event_cb(btn_b2,btn_b2_event_cb,LV_EVENT_ALL,NULL);

    lv_obj_t *label_btn_b2 = lv_label_create(btn_b2);
    lv_label_set_text(label_btn_b2,"button_b2");
    lv_obj_center(label_btn_b2);
