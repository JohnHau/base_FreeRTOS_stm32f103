...
static void ILI9341_delay(uint16_t n)
{
	uint16_t i=0;
	uint16_t j=0;	
	while(n)
...
void ili9341_init(void)
{
    ...
    ILI9341_delay(5);//LV_DRV_DELAY_MS(5);
    ...
    ILI9341_delay(10);//LV_DRV_DELAY_MS(100);

    /* display on */
    ili9341_write(ILI9341_CMD_MODE, ILI9341_DISPON);

    ILI9341_delay(2);//LV_DRV_DELAY_MS(20);
}
